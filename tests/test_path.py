...
class TestEllipsoidFit(unittest.TestCase):
    ...
    def test_diagonal_path(self):
        ...
        self.assertEquals(numpy.sqrt(2), path.get_path_position_2d(Particle(1, 1, 0)))
    ...
    def test_segments_of_different_length(self):
        ...
        self.assertAlmostEqual(10.44, path.get_path_position_2d(Particle(10, 0, 0)), places=2)
