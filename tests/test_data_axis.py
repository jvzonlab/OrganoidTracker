...
class TestDataAxis(unittest.TestCase):
    ...
    def test_horizontal_path(self):
        ...
        self.assertEquals(15, path.to_position_on_axis(Particle(15, 0, 0)).pos)  # Test a position on the path
        self.assertEquals(19, path.to_position_on_axis(Particle(19, 3, 3)).pos)  # Test a position next to the path
    ...
    def test_diagonal_path(self):
        ...
        self.assertEquals(numpy.sqrt(2), path.to_position_on_axis(Particle(1, 1, 0)).pos)
    ...
    def test_segments_of_different_length(self):
        ...
        self.assertAlmostEqual(10.44, path.to_position_on_axis(Particle(10, 0, 0)).pos, places=2)
    ...
    def test_reposition_offset(self):
        ...
        self.assertEquals(5, path.to_position_on_axis(Particle(5, 0, 0)).pos)
        path.update_offset_for_particles([Particle(5, 0, 0), Particle(6, 0, 0)])
        self.assertEquals(0, path.to_position_on_axis(Particle(5, 0, 0)).pos)  # Make sure zero-point has moved
