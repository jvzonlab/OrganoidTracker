...
class TestLines(TestCase):
    ...
    def test_direction_along_z_line(self):
        ...
        self.assertEqual(270, lines.direction_to_point(line_in_z_direction, point))

        # Make sure this matches the 2D case
        self.assertEqual(270, angles.direction_2d(line_in_z_direction.point, point))

    def test_direction_along_x_line(self):
        line_along_x_axis = Line3(Vector3(0, 0, 0), Vector3(6, 0, 0))
