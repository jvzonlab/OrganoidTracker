...
class TestFindNearestFew(unittest.TestCase):
    ...
    def test_find_two(self):
        ...
        positions = set()
        positions.add(Position(10,20,0).with_time_point(time_point))
        positions.add(Position(11,20,0).with_time_point(time_point))
        positions.add(Position(100,20,0).with_time_point(time_point))
