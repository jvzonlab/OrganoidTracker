...
class TestLinksComparison(unittest.TestCase):
    ...
    def test_movement_reports(self):
        ...
        a1 = Position(0, 0, 0).with_time_point_number(1)
        a2 = Position(1, 0, 0).with_time_point_number(2)
        a3 = Position(2, 0, 0).with_time_point_number(3)
        ...
        b1 = Position(1, 0, 0).with_time_point_number(1)
        b2 = Position(2, 0, 0).with_time_point_number(2)
        b3 = Position(12, 0, 0).with_time_point_number(3)  # Simulate rapid movement, which may indicate mistracking
    ...
    def test_missed_division(self):
        ...
        a1 = Position(0, 0, 0).with_time_point_number(1)
        a2 = Position(-1, 0, 0).with_time_point_number(2)
        a3 = Position(1, 0, 0).with_time_point_number(2)
        ground_truth = _experiment(a1, a2, a3)
        ground_truth.links.add_link(a1, a2)
        ...
        b1 = Position(0, 0, 0).with_time_point_number(1)
        b2 = Position(-1, 0, 0).with_time_point_number(2)
        b3 = Position(1, 0, 0).with_time_point_number(2)
        scratch = _experiment(b1, b2, b3)
        scratch.links.add_link(b1, b2)
    ...
    def test_one_track_missed(self):
        ...
        a2 = Position(1, 0, 0).with_time_point_number(2)
        a3 = Position(2, 0, 0).with_time_point_number(3)
        a101 = Position(10, 0, 0).with_time_point_number(1)
        a102 = Position(11, 0, 0).with_time_point_number(2)
        a103 = Position(12, 0, 0).with_time_point_number(3)
        ...
        b1 = Position(5, 0, 0).with_time_point_number(1)
        b2 = Position(6, 0, 0).with_time_point_number(2)
        b3 = Position(7, 0, 0).with_time_point_number(3)
        scratch = _experiment(b1, b2, b3)
        scratch.links.add_link(b1, b2)
        scratch.links.add_link(b2, b3)
