...
class TestLinksComparison(unittest.TestCase):
    ...
    def test_movement_reports(self):
        ...
        self.assertEqual(1, result.count_positions(lineage_comparison.LINEAGE_START_TRUE_POSITIVES))
        self.assertEqual(0, result.count_positions(lineage_comparison.LINEAGE_START_FALSE_NEGATIVES))
        self.assertEqual(2, result.count_positions(lineage_comparison.MOVEMENT_TRUE_POSITIVES))
        self.assertEqual(0, result.count_positions(lineage_comparison.MOVEMENT_DISAGREEMENT))

        result_lower_max_distance = lineage_comparison.compare_links(ground_truth, scratch, max_distance_um=5)
        self.assertEqual(1, result_lower_max_distance.count_positions(lineage_comparison.LINEAGE_START_TRUE_POSITIVES))
        self.assertEqual(0, result_lower_max_distance.count_positions(lineage_comparison.LINEAGE_START_FALSE_NEGATIVES))
        self.assertEqual(1, result_lower_max_distance.count_positions(lineage_comparison.MOVEMENT_TRUE_POSITIVES))
        self.assertEqual(1, result_lower_max_distance.count_positions(lineage_comparison.MOVEMENT_DISAGREEMENT))
    ...
    def test_missed_division(self):
        ...
        self.assertEqual(1, result.count_positions(lineage_comparison.DIVISIONS_FALSE_NEGATIVES))
        self.assertEqual(0, result.count_positions(lineage_comparison.DIVISIONS_TRUE_POSITIVES))
        self.assertEqual(0, result.count_positions(lineage_comparison.DIVISIONS_FALSE_POSITIVES))
    ...
    def test_one_track_missed(self):
        ...
        self.assertEqual(1, result.count_positions(lineage_comparison.LINEAGE_START_TRUE_POSITIVES))
        self.assertEqual(1, result.count_positions(lineage_comparison.LINEAGE_START_FALSE_NEGATIVES))
