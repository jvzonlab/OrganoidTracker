...
class _CloneDistributionTask(Task):
    ...
    def __init__(self, gui_experiment: GuiExperiment, links: PositionLinks, time_point_window: int, first_time_point_number: int,
...
def _get_clone_sizes_list(links: PositionLinks, time_point_window: int, first_time_point_number: int, last_time_point_number: int) -> ndarray:
    clone_sizes = list()
