...
_pixel_size_x_um = float(config.get_or_default("pixel_size_x_um", str(0.32)))
_pixel_size_y_um = float(config.get_or_default("pixel_size_y_um", str(0.32)))
_pixel_size_z_um = float(config.get_or_default("pixel_size_z_um", str(2)))
_time_point_duration_m = float(config.get_or_default("time_point_duration_m", str(12)))
