...
_method = config.get_or_default("track finding method", "FlowBased")
...
# it might be better to move this to after connect_loose_ends() and use 'experiment' not 'experiment_all' as the reference graph
...
io.save_data_to_json(experiment_all, 'all_links_clean' + _links_output_file)
