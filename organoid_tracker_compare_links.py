...
_automatic_links_file = config.get_or_prompt("automatic_file", "In what file are the automatic links stored?")
...
if _margin_xy_px >= 0:
    ...
    _images_folder = None
    _images_format = None
_output_file = config.get_or_default("output_file", "links_comparison.json", type=config_type_json_file)
