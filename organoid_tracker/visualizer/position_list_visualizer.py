...
class PositionListVisualizer(Visualizer):
    ...
    def _show_image(self):
        ...
        image_2d = self._return_2d_image(time_point, int(round(current_position.z)), self._display_settings.image_channel, self._display_settings.show_next_time_point)
        if image_2d is not None:
            ...
            self._ax.imshow(image_2d, cmap=self._get_color_map(), extent=extent, interpolation="nearest")
