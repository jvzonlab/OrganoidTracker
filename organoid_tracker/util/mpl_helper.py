...
SANDER_APPROVED_COLORS = matplotlib.colors.to_rgba_array(["#55efc4", "#fdcb6e", "#636e72", "#74b9ff", "#e84393",
...
def _create_qualitative_colormap() -> ListedColormap:
    color_list = matplotlib.colormaps.get_cmap('jet')(numpy.linspace(0, 1, 256))
