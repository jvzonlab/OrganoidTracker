...
__info = {
    Error.TRACK_END: (Severity.WARNING, "This cell has no links to the future. Please check if this is correct."),
    Error.POTENTIALLY_NOT_A_MOTHER: (Severity.WARNING, "This division is maybe wrong; nearby cell has similar likeliness."),
    Error.MISSED_DIVISION: (Severity.WARNING, "A division was probably missed here; found a high division score."),
    ...
    Error.SHORT_CELL_CYCLE: (Severity.ERROR, "This division appeared very quickly after the previous. One of those is likely wrong."),
    Error.LOW_DIVISION_SCORE: (Severity.WARNING, "This division is maybe wrong; division score is low."),
