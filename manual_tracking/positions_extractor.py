...
def extract_positions(tracks_dir: str, output_file: str, max_frame: int = 5000) -> None:
    ...
    for track_file in track_files:
        ...
        if match:
            _extract_positions_from_track(os.path.join(tracks_dir, track_file), all_positions, max_frame=max_frame)
...
def _extract_positions_from_track(track_file : str, all_positions : Positions, max_frame: int = 5000):
