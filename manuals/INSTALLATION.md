...
Download and install Anaconda/Miniconda and open the Anaconda Prompt. Use the `cd` command to navigate to the directory of OrganoidTracker. Run the following commands:
    ...
    conda create -n organoid_tracker -c ilastik-forge -c esri -c conda-forge  python=3.9 dpct matplotlib-base tifffile scikit-image scipy nd2reader opencv pyside2 tensorflow-gpu tensorflow-addons
